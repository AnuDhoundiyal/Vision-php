<?php
/**
 * VisionNEX PHP Attendance System - Face Recognition Kiosk
 * Real-time face recognition interface for attendance marking
 */
...
$face_threshold = $settings['face_recognition_threshold'] ?? 0.85;
$auto_capture_delay = $settings['auto_capture_delay'] ?? 5;
$institution_name = $settings['institution_name'] ?? 'VisionNEX University';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-blue-200 text-sm"><?= htmlspecialchars($institution_name) ?></p>
                </div>
            </div>
                    ...
                    <div class="camera-container bg-gray-900 aspect-video mb-6 relative">
                        ...
                        <div id="successOverlay" class="recognition-overlay hidden">
                            <div class="text-center text-white success-animation">
                                ...
                                <p id="recognizedDetails" class="text-blue-200 text-sm mt-2"></p>
                            </div>
                        </div>
                        ...
                        <div id="errorOverlay" class="recognition-overlay hidden">
                            <div class="text-center text-white">
                                ...
                                <p id="errorMessage" class="text-red-300">Face not recognized or not registered</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-2xl p-8 w-full max-w-md">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="range" id="confidenceThreshold" min="0.5" max="1.0" step="0.05" value="<?= $face_threshold ?>" class="w-full">
                    <div class="flex justify-between text-xs text-gray-500 mt-1">
                        <span>50%</span>
                        <span id="confidenceValue"><?= round($face_threshold * 100) ?>%</span>
                        <span>100%</span>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <select id="autoCaptureDelay" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <option value="3" <?= $auto_capture_delay == 3 ? 'selected' : '' ?>>3 seconds</option>
                        <option value="5" <?= $auto_capture_delay == 5 ? 'selected' : '' ?>>5 seconds</option>
                        <option value="10" <?= $auto_capture_delay == 10 ? 'selected' : '' ?>>10 seconds</option>
                    </select>
                </div>
